...
function s_doPlugins(s) {
    ...
    if (!sc_alreadySent) {
        ...
        // Current Price on ProductDetailPage
        if (typeof (window.sc_a_p) != "undefined" && window.sc_a_p != "") {
            s.eVar41 = window.sc_a_p;
            s.prop41 = "D=v41";
        }
...
s.addToList = new Function("l", "s", "if(l){if(s){return l+','+s}else{retu" + "rn l}}else{return s}");
